...
#          Note that the true identity of the pet in the image is 
...
#          program will be comparing the performance of 3 different CNN model
...
def main():
    ...
    # Function that checks command line arguments using in_arg which contains in 
    ...
    # which contains in print_functions_for_lab_checks.py    
    ...
    # Function that checks Results Dictionary using results which contains in 
    # print_functions_for_lab_checks.py   
    ...
    # Calculates results of run and puts statistics in the Results Statistics Dictionary
